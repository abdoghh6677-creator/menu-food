        ...
        <div className="relative w-full h-48 rounded-xl overflow-hidden bg-gray-100 group">
          ...
          {uploading && (
            <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center gap-2">
              ...
              <p className="text-white text-sm font-medium">جاري الرفع...</p>
            </div>
          )}
          {!uploading && (
        ...
        >
          {uploading ? (
            <>
              ...
              <p className="text-accent font-semibold text-sm">جاري الرفع...</p>
            </>
          ) : (
            <>
              ...
              <p className="text-text-secondary text-xs mt-1">PNG, JPG, WEBP — حتى 5MB</p>
            </>
          )}
        </div>
      )}
